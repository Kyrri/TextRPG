...
public class BattleSystem<atk, atk1> extends JFrame implements ActionListener{
        ...
        frame.addWindowListener(new WindowAdapter() {
            public void windowClosing(WindowEvent e) {
                if(allowClose){
                    ...
                    updateText("Sie müssen den Kampf erst beenden!");
                }
            }
        });
        //Set Labels
    ...
    private void disableButtons() {
        ...
        do{
            ...
            sec2 = t2 / 1000;
            updateText("Spieler erholt sich "+(5-(sec2-sec1))+ " Sekunden warten!");
